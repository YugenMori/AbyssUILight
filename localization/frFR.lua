local L = LibStub("AceLocale-3.0"):NewLocale("AbyssUIClassic", "frFR")
...
L["Supporters:"] = "Partisans:"
L["Auto Repair"] = "Réparation automobile"
L["Auto Sell Gray Items"] = "Vente automatique d'articles gris"
L["When you open a Merchant shop, auto sell gray"] = "Lorsque vous ouvrez une boutique marchande, vendez automatiquement du gris"
L["When you open a Merchant shop auto repair items"] = "Lorsque vous ouvrez une boutique marchande d'articles de réparation automobile"
L["Default Character NameText"] = "Nom du personnage par défaut"
L["Disable the character name colorization back to the default font color"] = "Désactivez la colorisation du nom des caractères et rétablissez la couleur de police par défaut"
L["AbyssUI Classic icon borders, a Blizzard Default enchanced theme"] = "Bordures d'icônes AbyssUI Classic, un thème amélioré par défaut de Blizzard"
L["Icons"] = "Icônes"
L["- Icons"] = "- Icônes"
L["Shaman Pink"] = "Chaman Rose"
L["Keep the color pink for Shaman health bars (portrait and tooltip)"] = "Gardez la couleur rose pour les barres de santé des chamans (portrait et info-bulle)"
L["Disable Guild Tooltip"] = "Désactiver l'info-bulle de guilde"
L["Remove the guild name from tooltips"] = "Supprimer le nom de la guilde des info-bulles"
L["Default Background"] = "Arrière-plan par défaut"
L["Disable Square Minimap"] = "Désactiver la mini-carte carrée"
L["Rare Portrait"] = "Portraits rares"
L["Add a rare texture to the player portrait"] = "Ajoutez une texture rare au portrait du joueur"
L["Remove the class color background behind"
.." the player names to default values (Transparent Name needs to be unchecked)"] = "Supprimez l'arrière-plan de couleur de la classe derrière"
.." les noms des joueurs aux valeurs par défaut (le nom transparent doit être décoché)"
L["This option will get you back to the"..
  " Blizzard default minimap style (round). *You need to restart the game so round textures can be re-loaded"] = "Cette option vous ramènera au"..
