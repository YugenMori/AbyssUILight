...
L["Disable Tooltip Health"] = "Отключить здоровье всплывающей подсказки"
L["Disable the tooltip healthBar from mouse hover functions"] = "Отключить панель состояния всплывающей подсказки от функций наведения мыши"
L["Dragonflight UnitFrame"] = true
L["Supporters:"] = "Сторонники:"
L["Auto Repair"] = "Авторемонт"
L["Auto Sell Gray Items"] = "Автопродажа серых вещей"
L["When you open a Merchant shop, auto sell gray"] = "Когда вы открываете торговый магазин, автоматическая продажа серого цвета"
L["When you open a Merchant shop auto repair items"] = "При открытии Торгового магазина авторемонтных товаров"
L["Default Character NameText"] = "Текст имени персонажа по умолчанию"
L["Disable the character name colorization back to the default font color"] = "Отключить раскрашивание имени персонажа и вернуть цвет шрифта по умолчанию"
L["AbyssUI Classic icon borders, a Blizzard Default enchanced theme"] = "Рамки значков AbyssUI Classic, улучшенная тема Blizzard по умолчанию"
L["Icons"] = "Иконы"
L["- Icons"] = "- Иконки"
L["Shaman Pink"] = "Шаман Розовый"
L["Keep the color pink for Shaman health bars (portrait and tooltip)"] = "Оставьте розовый цвет полосок здоровья Шамана (портрет и подсказка)"
L["Disable Guild Tooltip"] = "Отключить подсказку о гильдии"
L["Remove the guild name from tooltips"] = "Удалить название гильдии из всплывающих подсказок"
L["Default Background"] = "Фон по умолчанию"
L["Disable Square Minimap"] = "Отключить квадратную миникарту"
L["Rare Portrait"] = "Редкий портрет"
L["Add a rare texture to the player portrait"] = "Добавьте редкую текстуру на портрет игрока"
L["Remove the class color background behind"
.." the player names to default values (Transparent Name needs to be unchecked)"] = "Удалить цвет фона класса позади"
.." имена игроков имеют значения по умолчанию (флажок «Прозрачное имя» необходимо снять)"
L["This option will get you back to the"..
  " Blizzard default minimap style (round). *You need to restart the game so round textures can be re-loaded"] = "Эта опция вернет вас обратно в "..
