local L = LibStub("AceLocale-3.0"):NewLocale("AbyssUIClassic", "ptBR")
...
L["Disable Tooltip Health"] = "Desativar vida da Tooltip"
L["Disable the tooltip healthBar from mouse hover functions"] = "Desativa a barra de vida da dica de ferramenta ao passar o mouse"
L["Dragonflight UnitFrame"] = true
L["Supporters:"] = "Membros:"
L["Auto Repair"] = "Auto Reparar"
L["Auto Sell Gray Items"] = "Vender Itens Cinza"
L["When you open a Merchant shop, auto sell gray"] = "Quando você fala com um mercador, vende os itens cinza automáticamente"
L["When you open a Merchant shop auto repair items"] = "Quando você fala com um mercador, repara os itens automáticamente"
L["Default Character NameText"] = "Nome Padrão de Personagem"
L["Disable the character name colorization back to the default font color"] = "Desativa a colorização ao padrão da fonte"
L["AbyssUI Classic icon borders, a Blizzard Default enchanced theme"] = "Borda de ícones AbyssUI Classic, um padrão Blizzard melhorado"
L["Icons"] = "Ícones"
L["- Icons"] = "- Ícones"
L["Shaman Pink"] = "Xamã Rosa"
L["Keep the color pink for Shaman health bars (portrait and tooltip)"] = "Mantenha a cor rosa para as barras de saúde do Shaman (retrato e tooltip)"
L["Disable Guild Tooltip"] = "Desativar Tooltip de guilda"
L["Remove the guild name from tooltips"] = "Remover o nome da guilda das dicas"
L["Default Background"] = "Fundo padrão"
L["Disable Square Minimap"] = "Desativar Minimapa Quadrado"
...
L["Members"] = "Membros"
L["Total of hours played: "] = "Total de horas jogadas: "
