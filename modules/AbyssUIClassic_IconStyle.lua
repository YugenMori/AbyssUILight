...
local function OldSchoolTheme() 
    Abconfig.textures = {
    normal            = "Interface\\AddOns\\AbyssUIClassic\\textures\\iconstyle\\oldschoolbackup",
    bags              = "Interface\\AddOns\\AbyssUIClassic\\textures\\iconstyle\\oldschoolbackup",
    flash             = "Interface\\AddOns\\AbyssUIClassic\\textures\\iconstyle\\flash",
    hover             = "Interface\\AddOns\\AbyssUIClassic\\textures\\iconstyle\\hover",
    pushed            = "Interface\\AddOns\\AbyssUIClassic\\textures\\iconstyle\\pushed",
    checked           = "Interface\\AddOns\\AbyssUIClassic\\textures\\iconstyle\\checked",
  ...
  Abconfig.buffFrame = {
    ...
    border = {
      texture           = "Interface\\AddOns\\AbyssUIClassic\\textures\\iconstyle\\oldschoolbackup",
      color             = { r = 0.5, g = 0.5, b = 0.5, },
      classcolored      = false,
    },
    background = {
  ...
  if (AbyssUIClassicAddonSettings.DefaultIconBorder ~= true) then
    if (AbyssUIClassicAddonSettings.AbyssIconBorder ~= true) then
      ...
      local function styleActionButton(bu)
        ...
        elseif (AbyssUIClassicAddonSettings.ThinIconBorder == true or AbyssUIClassicAddonSettings.GlassIconBorder == true) then
          ic:SetTexCoord(0.06, 0.9, 0.06, 0.9)
          ic:SetPoint("TOPLEFT", bu, "TOPLEFT", 1, -1)
          ic:SetPoint("BOTTOMRIGHT", bu, "BOTTOMRIGHT", -1, 1)
        elseif ( AbyssUIClassicAddonSettings.OriginalIconBorder == true or AbyssUIClassicAddonSettings.ClassicIconBorder == true) then
          ic:SetTexCoord(0.05, 0.9, 0.05, 0.9)
          ic:SetPoint("TOPLEFT", bu, "TOPLEFT", 1, -1)
          ic:SetPoint("BOTTOMRIGHT", bu, "BOTTOMRIGHT", -1, 1)
        else
      ...
      local function applySkin(b)
        ...
        local border = _G[name.."Border"] or b:CreateTexture(name.."Border", "BACKGROUND", nil, -7)
          ...
          elseif (AbyssUIClassicAddonSettings.OldSchoolIconBorder) then
            border:SetTexture("Interface\\AddOns\\AbyssUIClassic\\textures\\iconstyle\\oldschoolbackup")
          else
            border:SetTexture("Interface\\AddOns\\AbyssUIClassic\\textures\\iconstyle\\classic")
          end
