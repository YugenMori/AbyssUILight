...
local function OldSchoolTheme() 
    Abconfig.textures = {
    normal            = "Interface\\AddOns\\AbyssUIClassic\\textures\\iconstyle\\abyssuiborder",
    bags              = "Interface\\AddOns\\AbyssUIClassic\\textures\\iconstyle\\abyssuiborder",
    flash             = "Interface\\AddOns\\AbyssUIClassic\\textures\\iconstyle\\flash",
    hover             = "Interface\\AddOns\\AbyssUIClassic\\textures\\iconstyle\\hover",
    pushed            = "Interface\\AddOns\\AbyssUIClassic\\textures\\iconstyle\\pushed",
    checked           = "Interface\\AddOns\\AbyssUIClassic\\textures\\iconstyle\\checked",
  ...
  Abconfig.buffFrame = {
    ...
    border = {
      texture           = "Interface\\AddOns\\AbyssUIClassic\\textures\\iconstyle\\abyssuiborder",
      color             = { r = 0.5, g = 0.5, b = 0.5, },
      classcolored      = false,
    },
    background = {
...
local function IconBackInit()
  ...
  local function applyBackground(bu)
    ...
    if Abconfig.background.showbg or Abconfig.background.showshadow then
      ...
      if Abconfig.background.showbg and not Abconfig.background.useflatbackground then
        ...
        --t:SetAllPoints(bu)
        AbyssUIClassic_ColorizationFrameFunction(t)
      end
  ...
  local function styleLeaveButton(bu)
    ...
    AbyssUIClassic_ColorizationFrameFunction(bo)
    bo:ClearAllPoints()
    bo:SetAllPoints(bu)
    --shadows+background
    if not bu.bg then applyBackground(bu) end
  ...
  f:SetScript("OnEvent", function(self)
    if GetWoWVersion < 90000 then
      ...
      styleDefaultOtherBag(_G["MainMenuBarBackpackButton"])
    end
  end)
  ...
  local function applySkin(b)
    ...
    border:SetTexture("Interface\\AddOns\\AbyssUIClassic\\textures\\iconstyle\\abyssuiborder")
...
--]]
  ...
  local function applySkinToAuras(self)
    for i = 1, MAX_TARGET_BUFFS do
      b = _G["TargetFrameBuff"..i]
      applySkin(b)
    end
