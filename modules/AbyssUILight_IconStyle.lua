...
-- Icon Style Module
--
-- This modules is inpired in LortiUI, so many users of AbyssUILight have requested this section to be implemented, so I did,
...
local mediaFolder = "Interface\\AddOns\\AbyssUILight\\textures\\font\\"
  if (locale == "zhCN") then
...
local function OldTheme() 
  ...
  Abconfig.buffFrame = {
    ...
    background = {
      show              = false,   --show backdrop
      edgeFile          = "Interface\\AddOns\\AbyssUILight\\textures\\iconstyle\\original",
...
local function IconThemeInit()
    if (AbyssUILightAddonSettings.GlossIconBorder ~= true and AbyssUILightAddonSettings.CrispIconBorder ~= true and
      AbyssUILightAddonSettings.OriginalIconBorder ~= true and AbyssUILightAddonSettings.SquareIconBorder ~= true and
      AbyssUILightAddonSettings.ThinIconBorder ~= true and AbyssUILightAddonSettings.GlassIconBorder ~= true and AbyssUILightAddonSettings.OldIconBorder ~= true) then
      GlossTheme()
    end
    ...
    if AbyssUILightAddonSettings.OldIconBorder then
      OldTheme()
      --if Abconfig.background.showshadow then edgefile = Abconfig.textures.crisp end
    end
