...
local function InitSettings()
  ...
  f:SetScript("OnEvent", function() 
    ...
    FrameButton.text:SetText("Github")
      if (AbyssUILightAddonSettings.FontsValue == true and AbyssUILightAddonSettings.ExtraFunctionDisableFontWhiteText ~= true) then
        AbyssUILight_ApplyFonts(FrameButton.text)
      else
        FrameButton.text:SetFont(globalFont, 12)
